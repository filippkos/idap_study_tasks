...
extension UIImage {
    ...
    public func getColors(quality: UIImageColorsQuality = .low, _ completion: @escaping (UIImageColors) -> Void) {
    ...
    public func getColors(quality: UIImageColorsQuality = .low) -> UIImageColors {
